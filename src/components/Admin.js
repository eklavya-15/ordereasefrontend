              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-100">
                  <tr>
                    ...
                    <th scope="col" className="px-4 py-2 text-left text-sm font-medium text-gray-700">Order Type</th>
                    ...
                    <th scope="col" className="px-4 py-2 text-left text-sm font-medium text-gray-700">Details</th>
